...
module.exports = function(request, options) {
    ...
    omitFields: function(records) {
        ...
        var ommisions = _.clone(options.omit);
        
        // Make sure omit option is an array, optionally exiting otherwise
        if (_.isString(ommisions)) {
            
            ommisions = [ommisions];
        } else if (!_.isArray(ommisions)) {
