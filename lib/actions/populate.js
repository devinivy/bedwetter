...
module.exports = function expand(route, origOptions) {
  ...
  return function(request, reply) {
    ...
    Hoek.assert(relation, 'Missing required route option, `options.associationAttr`.');

    var parentPk = actionUtil.requirePk();
    ...
    Model
      ...
      .exec(function found(err, matchingRecord) {
        ...
        Hoek.assert(matchingRecord[relation], 'Missing model association.');
